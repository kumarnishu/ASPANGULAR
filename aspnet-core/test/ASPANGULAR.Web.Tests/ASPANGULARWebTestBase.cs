...
{
    public abstract class ASPANGULARWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ASPANGULARWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ASPANGULARWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ASPANGULARDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ASPANGULARDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ASPANGULARDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ASPANGULARDbContext, Task<T>> func)
        {
            T result;
